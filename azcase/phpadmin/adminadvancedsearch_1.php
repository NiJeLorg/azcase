...
?>
<div class="clear"></div>
<h3>Sites, Activities and Ages Served</h3>
<?php
...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of School Year Sites: <strong>$schoolyearsitescount</strong><br />Number of Summer Sites: <strong>$summersitescount</strong><br />Number of Sites with Tutoring/Academic Enrichment as an Activity: <strong>$academicsitescount</strong><br />Number of Sites with Arts and Culture as an Activity: <strong>$artssitescount</strong><br />Number of Sites with Sports and Recreation as an Activity: <strong>$sportssitescount</strong><br />Number of Sites with Volunteering/Community Service as an Activity: <strong>$communitysitescount</strong><br />Number of Sites with Character Education as an Activity: <strong>$charactersitescount</strong><br />Number of Sites with Leadership as an Activity: <strong>$leadershipsitescount</strong><br />Number of Sites with Nutrition as an Activity: <strong>$nutritionsitescount</strong><br />Number of Sites with Prevention as an Activity: <strong>$preventionsitescount</strong><br />Number of Sites with Mentoring as an Activity: <strong>$mentoringsitescount</strong><br />Number of Sites with Support Services as an Activity: <strong>$supportservicessitescount</strong><br />Number of Sites with STEM as an Activity: <strong>$stemsitescount</strong><br />Number of Sites with College and Career Readiness as an Activity: <strong>$collegesitescount</strong><br />Number of Sites Serving Ages 5-8: <strong>$age5_8sitescount</strong><br />Number of Sites Serving Ages 9-11: <strong>$age9_11sitescount</strong><br />Number of Sites Serving Ages 12-14: <strong>$age12_14sitescount</strong><br />Number of Sites Serving Ages 15-18: <strong>$age15_18sitescount<br />]]></description>";
