...
?>
<div class="clear"></div>
<h3>Transportation, Food and Language Assistance</h3>
<?php
...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of Sites That Offer Transportation Assistance: <strong>$transportationcount</strong><br />Average Transportation Cost: <strong>$transportcostavg</strong><br />Number of Sites Where Snacks are Served: <strong>$snackscount</strong><br />Number of Sites Where Breakfast is Served: <strong>$breakfastcount</strong><br />Number of Sites Where Lunch is Served: <strong>$lunchcount</strong><br />Number of Sites Where Dinner is Served: <strong>$dinnercount</strong><br />Average Percentage of Students Participants in Free Lunch Program: <strong>$freelunchavg</strong><br />Number of Sites Where Spanish is Spoken: <strong>$spanishcount</strong><br />Number of Sites Where Other Languages are Spoken: <strong>$otherlanguagecount</strong><br />]]></description>";
