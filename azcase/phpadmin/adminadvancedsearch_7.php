...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Average Percentage of African Americans: <strong>$africanamericanavg</strong><br />Average Percentage of Asian Americans: <strong>$asianamericanavg</strong><br />Average Percentage of Latinos: <strong>$latinoavg</strong><br />Average Percentage of Native Americans: <strong>$nativeamericanavg</strong><br />Average Percentage of Whites: <strong>$whiteavg</strong><br />Average Percentage of Other Race or Ethnicity: <strong>$otherraceavg</strong><br />]]></description>";
