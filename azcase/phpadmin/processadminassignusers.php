...
header("Location: http://maps.nijel.org/azcase_dev/azcase/phpadmin/endadminassignusers.php?useremail=$useremail&userid=$userid&searchusername=$searchusername&searchuseremail=$searchuseremail&searchorgname=$searchorgname");
?>
