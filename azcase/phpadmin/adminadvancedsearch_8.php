...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of 21st Century Community Centers: <strong>$programtype1count</strong><br />Number of Faith-Based Programs: <strong>$programtype2count</strong><br />Number of Public School Based Programs: <strong>$programtype3count</strong><br />Number of Private School Based Programs: <strong>$programtype4count</strong><br />Number of Home Based Programs: <strong>$programtype5count</strong><br />Number of Corperate Run Programs: <strong>$programtype6count</strong><br />Number of Community Based Programs: <strong>$programtype7count</strong><br />]]></description>";
