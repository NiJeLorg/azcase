...
$kmlbody .= "	<Placemark>
		<name>$name</name>
		<description><![CDATA[<strong>Address:</strong> $address $address2, $city, $state $zip <br />$schoolyearsites $summersites<br />]]></description>
		<Point>
...
?>
<body>
<h3 class="azcase-text-color">Export Data for All Programs, Users and Sites</h3>
<h4 class="azcase-text-color">Export all data for Sites</h4>
<a class="btn btn-default" href="exportcsv.php?filename=allsites.csv" role="button"><span class="glyphicon glyphicon-download" aria-hidden="true"></span> Export as CSV</a>
<br /><br />
<h4 class="azcase-text-color">Export all data for Locations</h4>
<a class="btn btn-default" href="exportcsv.php?filename=alllocations.csv" role="button"><span class="glyphicon glyphicon-download" aria-hidden="true"></span> Export as CSV</a>
<br /><br />
<a class="btn btn-default" href="exportcsv.php?filename=alllocations.kml" role="button"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Export as KML (Launches in Google Earth)</a>
<br /><br />
<h4 class="azcase-text-color">Export all data for Users</h4>
<a class="btn btn-default" href="exportcsv.php?filename=allusers.csv" role="button"><span class="glyphicon glyphicon-download" aria-hidden="true"></span> Export as CSV</a>
<br /><br />
