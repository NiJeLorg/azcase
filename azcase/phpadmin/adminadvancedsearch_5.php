...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Average Site Capacity: <strong>$capacityavg</strong><br />Number of Sites at Capacity: <strong>$atcapacitycount</strong><br />Number of Children Served: <strong>$servedcount</strong><br />Average Number of Children Served: <strong>$servedavg</strong><br />Average Number Full-Time Staff: <strong>$fulltimestaffavg</strong><br />Average Number Part-Time Staff: <strong>$parttimestaffavg</strong><br />Average Number Volunteer Staff: <strong>$volunteerstaffavg</strong><br />Average Number Working Staff: <strong>$workingstaffavg</strong><br />]]></description>";
