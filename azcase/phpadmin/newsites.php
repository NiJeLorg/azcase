...
?>
<body>
<h3 class="azcase-text-color">Add New Programs</h3>
<p>Please add new programs using the form below. Here you can add up to 30 programs that have the <em>same information</em> on activities, ages served, and hours of operation. You'll have the opportunity later to add other programs that have different activities, hours, and ages served. Thank you!</p>
<p><strong>Please note</strong> that you will be able to designate these programs as <strong>school year or summer programs</strong> later on in the process.</p>
<?php
