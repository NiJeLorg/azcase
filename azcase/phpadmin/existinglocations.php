...
if (pg_numrows($record)==0) {
	...
	header("Location: https://azcase.nijel.org/php/newlocations.php"); 
...
if ($lt==0) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue01.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue01.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue01.png\" alt=\"1\" /></td>";
}elseif ($lt==1) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue02.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue02.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue02.png\" alt=\"2\" /></td>";
}elseif ($lt==2) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue03.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue03.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue03.png\" alt=\"3\" /></td>";
}elseif ($lt==3) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue04.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue04.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue04.png\" alt=\"4\" /></td>";
}elseif ($lt==4) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue05.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue05.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue05.png\" alt=\"5\" /></td>";
}elseif ($lt==5) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue06.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue06.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue06.png\" alt=\"6\" /></td>";
}elseif ($lt==6) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue07.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue07.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue07.png\" alt=\"7\" /></td>";
}elseif ($lt==7) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue08.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue08.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue08.png\" alt=\"8\" /></td>";
}elseif ($lt==8) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue09.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue09.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue09.png\" alt=\"9\" /></td>";
}elseif ($lt==9) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue10.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue10.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue10.png\" alt=\"10\" /></td>";
}elseif ($lt==10) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue11.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue11.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue11.png\" alt=\"11\" /></td>";
}elseif ($lt==11) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue12.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue12.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue12.png\" alt=\"12\" /></td>";
}elseif ($lt==12) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue13.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue13.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue13.png\" alt=\"13\" /></td>";
}elseif ($lt==13) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue14.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue14.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue14.png\" alt=\"14\" /></td>";
}elseif ($lt==14) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue15.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue15.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue15.png\" alt=\"15\" /></td>";
}elseif ($lt==15) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue16.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue16.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue16.png\" alt=\"16\" /></td>";
}elseif ($lt==16) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue17.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue17.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue17.png\" alt=\"17\" /></td>";
}elseif ($lt==17) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue18.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue18.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue18.png\" alt=\"18\" /></td>";
}elseif ($lt==18) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue19.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue19.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue19.png\" alt=\"19\" /></td>";
}elseif ($lt==19) {
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/darkblue20.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/darkblue20.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/darkblue20.png\" alt=\"20\" /></td>";
}else{
	$iconsLayer .= "['https://azcase.nijel.org/php/icons/icon.png']";
	$shadowsLayer .= "['https://azcase.nijel.org/php/icons/icon.shadow.png']";
	$sidebar .= "<tr><td><img src=\"https://azcase.nijel.org/php/icons/icon.png\" alt=\"icon\" /></td>";
}
...
if ($countschoolyear>0) {
	...
	$record1 = pg_query($connection, $sitequery);
	  for ($lt1 = 0; $lt1 < pg_numrows($record1); $lt1++) {
		...
		$schoolyearsites .= '<li><a href=\"https://azcase.nijel.org/php/site.php?siteid=';
		...
		$schoolyearsites .= '</a> | <a href=\"https://azcase.nijel.org/php/editsite.php?siteid=';
		$schoolyearsites .= $siteid;
...
if ($countsummer>0) {
	...
	$record1 = pg_query($connection, $sitequery);
	  for ($lt1 = 0; $lt1 < pg_numrows($record1); $lt1++) {
		...
		$summersites .= '<li><a href=\"https://azcase.nijel.org/php/site.php?siteid=';
		$summersites .= $siteid;
		...
		$summersites .= '</a> | <a href=\"https://azcase.nijel.org/php/editsite.php?siteid=';
		$summersites .= $siteid;
