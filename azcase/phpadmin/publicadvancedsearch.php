...
if ($azcongresswhere!='' || $statelegwhere!='' || $elemschooldistrictwhere!='' || $unionschooldistrictwhere!='' || $citieswhere!='' || $whereactivity!='' || $whereages!='') {
	...
	$yousearchedfor = '<h4>Site/Location Filters Chosen</h4>';
	$yousearchedfor .= '<ul>';

	if ($summeronly=='t') {
		$whereverified .= "AND summer = TRUE ";
		$yousearchedfor .= '<li><strong>Summer Sites Only</strong></li>';
	}elseif ($summeronly=='f') {
		$whereverified .= "AND summer = FALSE ";
		$yousearchedfor .= '<li><strong>School Year Sites Only</strong></li>';
	}else{}
...
if (!$azcongresssearch) {
	...
	$yousearchedfor .= '<li><strong>Congresional Districts:</strong> ' . $azcongresssearch . '</li>';
}

if (!$statelegsearch) {
}else{
	$yousearchedfor .= '<li><strong>State Legislative Districts:</strong> ' . $statelegsearch . '</li>';
}

if (!$elemschooldistrictsearch) {
}else{
	$yousearchedfor .= '<li><strong>Elementary School Districts:</strong> ' . $elemschooldistrictsearch . '</li>';
}

if (!$unionschooldistrictsearch) {
}else{
	$yousearchedfor .= '<li><strong>Secondary/Union School Districts:</strong> ' . $unionschooldistrictsearch . '</li>';
}

if (!$citiessearch) {
}else{
	$yousearchedfor .= '<li><strong>City:</strong> ' . $citiessearch . '</li>';
}

if (!$categorysearch) {
}else{
	$yousearchedfor .= '<li><strong>Activities:</strong> ' . $categorysearch . '</li>';
}

if (!$agesearch) {
}else{
	$yousearchedfor .= '<li><strong>Ages Served:</strong> ' . $agesearch . '</li>';
}
...
?>
<body>
<h3>Public Advanced Search Results</h3>
