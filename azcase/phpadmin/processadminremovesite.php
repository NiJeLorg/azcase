...
header("Location: http://maps.nijel.org/azcase_dev/azcase/phpadmin/endadminremovesite.php?searchname=$searchname&searchemail=$searchemail&searchphone=$searchphone");
?>
