...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Average Percentage of Program Budget From Federal Government: <strong>$budgetfederalavg</strong><br />Average Percentage of Program Budget From State or Local Government: <strong>$budgetlocalavg</strong><br />Average Percentage of Program Budget From Parent Fees: <strong>$budgetfeesavg</strong><br />Average Percentage of Program Budget From Grants: <strong>$budgetgrantavg</strong><br />Average Percentage of Program Budget From Religious Organizations: <strong>$budgetreligiousavg</strong><br />]]></description>";
