...
?>
<body>
<h3 class="azcase-text-color">Edit Additional Information for <?php echo $sitename; ?></h3>
<p>Please complete this form below for the site, <strong><?php echo $sitename; ?></strong>, located at <strong><?php echo $locationname; echo ' (' . $printaddress . ')'; ?></strong>.</p>
<?php
