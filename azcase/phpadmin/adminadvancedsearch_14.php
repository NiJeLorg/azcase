...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of Sites That Evaluate The Quality of The Site : <strong>$evaluate_programcount</strong><br />Number of Sites Perform Informal Self-Assessments: <strong>$evaluate_type1count</strong><br />Number of Sites Perform Formal Self-Assessments with Agreed Upon Criteria : <strong>$evaluate_type4count</strong><br />Number of Sites Perform Parent/Client Surveys: <strong>$evaluate_type5count</strong><br />Number of Sites Perform Host School Evaluations: <strong>$evaluate_type6count</strong><br />Number of Sites Perform Evaluations with Nationally Recognized Assessments or Accreditation Tools: <strong>$evaluate_type7count</strong><br />Number of Sites Perform Evaluations with Other Tools: <strong>$evaluate_type8count</strong><br />]]></description>";
