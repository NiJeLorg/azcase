...
?>
<div class="clear"></div>
<h3>Child/Teen Planned Activities and School Collaboration</h3>
<?php
...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of Sites That Allow Children/Teens to Plan Activities At Least Weekly : <strong>$youth_planactivity1count</strong><br />Number of Sites That Allow Children/Teens to Plan Activities Monthly: <strong>$youth_planactivity2count</strong><br />Number of Sites That Allow Children/Teens to Plan Activities Quarterly : <strong>$youth_planactivity3count</strong><br />Number of Sites That Allow Children/Teens to Plan Activities Annually: <strong>$youth_planactivity4count</strong><br />Number of Sites That Allow Children/Teens to Plan Activities Less Than Annually: <strong>$youth_planactivity5count</strong><br />Number of Sites That Allow Children/Teens to Create Rules At Least Weekly: <strong>$youth_makerules1count</strong><br />Number of Sites That Allow Children/Teens to Create Rules Monthly : <strong>$youth_makerules2count</strong><br />Number of Sites That Allow Children/Teens to Create Rules Quarterly : <strong>$youth_makerules3count</strong><br />Number of Sites That Allow Children/Teens to Create Rules Annually : <strong>$youth_makerules4count</strong><br />Number of Sites That Allow Children/Teens to Create Rules Less Than Annually : <strong>$youth_makerules5count</strong><br />Number of Sites That Regularly Collaborate with Schools: <strong>$collab_schoolcount</strong><br />Number of Sites That Collaborate with Schools Weekly: <strong>$collab_schoolfreq1count</strong><br />Number of Sites That Collaborate with Schools Monthly: <strong>$collab_schoolfreq2count</strong><br />Number of Sites That Collaborate with Schools Quarterly : <strong>$collab_schoolfreq3count</strong><br />Number of Sites That Collaborate with Schools Less Than Quarterly: <strong>$collab_schoolfreq4count</strong><br />]]></description>";
