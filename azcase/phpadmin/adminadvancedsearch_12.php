...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of Sites that Provide Staff Training/Professional Development Monthly : <strong>$prodevelop1count</strong><br />Number of Sites that Provide Staff Training/Professional Development Quarterly: <strong>$prodevelop2count</strong><br />Number of Sites that Provide Staff Training/Professional Development Semi-annually : <strong>$prodevelop3count</strong><br />Number of Sites that Provide Staff Training/Professional Development Annually : <strong>$prodevelop4count</strong><br />Number of Sites that Provide Staff Training/Professional Development Less Than Once a Year: <strong>$prodevelop5count</strong><br />Average Hours of Training/Professional Development Provided: <strong>$prodevelophoursavg</strong><br />Number of Sites that Rank On-line Training First: <strong>$prodevelop_rankmost11count</strong><br />Number of Sites that Rank Workshops/Conferences First: <strong>$prodevelop_rankmost12count</strong><br />Number of Sites that Rank Trainers Specializing in Specific Subject Matter First: <strong>$prodevelop_rankmost13count</strong><br />Number of Sites that Rank Peer to Peer Coaching First: <strong>$prodevelop_rankmost14count</strong><br />Number of Sites that Rank Supervision First: <strong>$prodevelop_rankmost15count</strong><br />Number of Sites that Rank On-line Training Second: <strong>$prodevelop_rank21count</strong><br />Number of Sites that Rank Workshops/Conferences Second: <strong>$prodevelop_rank22count</strong><br />Number of Sites that Rank Trainers Specializing in Specific Subject Matter Second: <strong>$prodevelop_rank23count</strong><br />Number of Sites that Rank Peer to Peer Coaching Second: <strong>$prodevelop_rank24count</strong><br />Number of Sites that Rank Supervision Second: <strong>$prodevelop_rank25count</strong><br />Number of Sites that Rank On-line Training Third: <strong>$prodevelop_rank31count</strong><br />Number of Sites that Rank Workshops/Conferences Third: <strong>$prodevelop_rank32count</strong><br />Number of Sites that Rank Trainers Specializing in Specific Subject Matter Third: <strong>$prodevelop_rank33count</strong><br />Number of Sites that Rank Peer to Peer Coaching Third: <strong>$prodevelop_rank34count</strong><br />Number of Sites that Rank Supervision Third: <strong>$prodevelop_rank35count</strong><br />Number of Sites that Rank On-line Training Fourth: <strong>$prodevelop_rank41count</strong><br />Number of Sites that Rank Workshops/Conferences Fourth: <strong>$prodevelop_rank42count</strong><br />Number of Sites that Rank Trainers Specializing in Specific Subject Matter Fourth: <strong>$prodevelop_rank43count</strong><br />Number of Sites that Rank Peer to Peer Coaching Fourth: <strong>$prodevelop_rank44count</strong><br />Number of Sites that Rank Supervision Fourth: <strong>$prodevelop_rank45count</strong><br />Number of Sites that Rank On-line Training Last: <strong>$prodevelop_rankleast51count</strong><br />Number of Sites that Rank Workshops/Conferences Last: <strong>$prodevelop_rankleast52count</strong><br />Number of Sites that Rank Trainers Specializing in Specific Subject Matter Last: <strong>$prodevelop_rankleast53count</strong><br />Number of Sites that Rank Peer to Peer Coaching Last: <strong>$prodevelop_rankleast54count</strong><br />Number of Sites that Rank Supervision Last: <strong>$prodevelop_rankleast55count</strong><br />]]></description>";
  ...
  <description>Arizona Afterschool Program Directory Sites by Congressional District KML File</description>
	...
	<Style id='Q5'><PolyStyle><color>af0000b3</color></PolyStyle></Style>
	  <ScreenOverlay>
	    ...
	    <Icon>
	      <href>https://azcase.nijel.org/php/icons/legend.png</href>
	    </Icon>
