...
if ($useremail!=$_SESSION['useremail']) {
	...
	/* Notify that no email exists and kill script */
		require('header.php');
		echo "<h3>Email Address Already in Use</h3><p>The email address you entered is already in use in the system. Please go back and change the email address entered.</p><p>Email address entered: <strong>$useremail</strong></p>";
		require('footer.php');
		die();
	}else{}
}else{}
...
header("Location: https://azcase.nijel.org/php/endadminedituser.php");
?>
