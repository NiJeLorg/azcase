...
?>
<div class="clear"></div>
<h3>Charges, Costs and Finacial Assistance</h3>
<?php
...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <strong>$sitescount</strong><br />Number of Sites That Charge a Fee: <strong>$chargecount</strong><br />Number of Sites that Charge Weekly (Avg. Cost): <strong>$costfrequency1count ($costamountavg1)</strong><br />Number of Sites that Charge Monthly (Avg. Cost): <strong>$costfrequency2count ($costamountavg2)</strong><br />Number of Sites that Charge Quarterly (Avg. Cost): <strong>$costfrequency3count ($costamountavg3)</strong><br />Number of Sites that Charge Per School Semester (Avg. Cost): <strong>$costfrequency4count ($costamountavg4)</strong><br />Number of Sites that Charge Annually (Avg. Cost): <strong>$costfrequency5count ($costamountavg5)</strong><br />Number of Sites that Charge for a Summer Session (Avg. Cost): <strong>$costfrequency6count ($costamountavg6)</strong><br />Number of Sites Offering Financial Assistance: <strong>$feeassistancecount</strong><br />Number of Sites Offering Scholarships: <strong>$scholarshipcount</strong><br />Number of Sites Offering DES Assistance: <strong>$desassistancecount</strong><br />Number of Sites Offering Multiple Child Discounts: <strong>$mcdiscountcount</strong><br />Number of Sites Offering Other Finacial Assistance: <strong>$otherassistancecount</strong><br />]]></description>";
