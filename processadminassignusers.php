...
$url = "http://maps.nijel.org/azcase/resetpassword.php?42=$randomtemppass";
$to = "$useremail";
...
header("Location: http://maps.nijel.org/azcase/endadminassignusers.php?useremail=$useremail&userid=$userid&searchusername=$searchusername&searchuseremail=$searchuseremail&searchorgname=$searchorgname");
?>
