...
$url = "http://maps.nijel.org/azcase_dev/resetpassword.php?42=$randomtemppass";
$to = "$useremail";
...
header("Location: http://maps.nijel.org/azcase_dev/endadminassignusers.php?useremail=$useremail&userid=$userid&searchusername=$searchusername&searchuseremail=$searchuseremail&searchorgname=$searchorgname");
?>
