...
define("API_KEY", "AIzaSyCb30KK9LewMPnmUAmeviWwTuJdAUES4WU");
...
if ($countschoolyear>0) {
	...
	$record1 = pg_query($connection, $sitequery);
	  for ($lt1 = 0; $lt1 < pg_numrows($record1); $lt1++) {
		...
		$schoolyearsites .= '<li><a href=\"https://azcase.nijel.org/phpsite/advancedsite.php?siteid=';
...
if ($countsummer>0) {
	...
	$record1 = pg_query($connection, $sitequery);
	  for ($lt1 = 0; $lt1 < pg_numrows($record1); $lt1++) {
		...
		$summersites .= '<li><a href=\"https://azcase.nijel.org/phpsite/advancedsite.php?siteid=';
		$summersites .= $siteid;
