...
<table>
	<tr>
		<td>
		<form name="skipthissite" id="skipthissite" action="thankyouadmineditsite.php" method="POST">
...
<br />
<form name="editsitesurvey" id="editsitesurvey" action="processadmineditsitesurvey.php" method="POST" onSubmit="return validateForm();">
