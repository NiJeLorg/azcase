...
require('updateadmineditsitesurvey.php');
...
header("Location: http://maps.nijel.org/azcase_dev/thankyouadmineditsite.php?searchname=$searchname&searchemail=$searchemail&searchphone=$searchphone");
?>
