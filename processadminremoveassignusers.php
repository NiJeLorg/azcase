...
header("Location: http://azcase.nijel.org/phpsite/endadminremoveassignusers.php?userid=$userid&searchusername=$searchusername&searchuseremail=$searchuseremail&searchorgname=$searchorgname");
?>
