...
if ($countsite==0) {
	header("Location: https://azcase.nijel.org/phpsite/thankyousites.php");
}else{
...
?>
<body>
<h1>Add Additional Information for Summer Site, <?php echo $sitename; ?></h1>
<p>Please make any changes below for the summer program, <b><?php echo $sitename; ?></b>, located at <b><?php echo $locationname; echo ' (' . $printaddress . ')'; ?></b>. Please note that these forms are <i>optional</i>, but the data you enter below will greatly assist the Arizona Center for Afterschool Excellence in our advocacy work. Thanks!</p>
<?php
