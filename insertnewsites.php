...
if (!$sitename1 || !$locationid1) {
	require('header.php');
	echo "<h1>Please Enter Data for a Site</h1><p>You did not enter any data on your sites on the last page. Please <a href=\"newsites.php\">go back</a> and add try again. Thanks! </p>";
	require('footer.php');
	die ();
}else{ 
