...
for ($lt = 0; $lt < pg_numrows($assignloopresult); $lt++) {
	...
	if ($_REQUEST["$userassignuserid"]=='t') {
		...
		if ($pgerror1!=FALSE) {
			require('header.php');
			echo "<h1>Save Error</h1><p><a href=\"providerhome.php\">&#60;&#60; Back to Your Admin Dashboard</a></p><p>An error occured when you attempted to remove an administrator from the system. An email was sent to NiJeL and we will address this problem. We're sorry for any inconvenience</p>";
			require('footer.php');
			$to = "jd@nijel.org";
...
header("Location: https://azcase.nijel.org/phpsite/endremoveassignedadmins.php");
?>
