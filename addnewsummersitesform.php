...
<b>Select Summer Program Activities:</b> 
<table cellpadding="2">
	<tr>
...
<table class="hoursTable" cellpadding="4">
	<tr>
		<th align="left" ><b>Select Summer Hours of Operation:</b></th>
		<th align="right" ><b>Start Time</b></th>
		<th align="right" ><b>End Time</b></th>
		<th class="lastcol"></th>
	</tr>
	<tr>
		<td class="firstcol" align="left"><b>Monday:</b></td>
		<td align="center"><select name="monstart"><?php echo $monstartcboxoptions; ?></select></td>
		<td align="center"><select name="monend"><?php echo $monendcboxoptions; ?></select></td>
	...
	<tr class="alt">
		...
		<td align="center"><select name="tuestart"><?php echo $tuestartcboxoptions; ?></select></td>
		<td align="center"><select name="tueend"><?php echo $tueendcboxoptions; ?></select></td>
		<td class="lastcol"></td>
	</tr>
	<tr>
		<td class="firstcol" align="left"><b>Wednesday:</b></td>
		<td align="center"><select name="wedstart"><?php echo $wedstartcboxoptions; ?></select></td>
		<td align="center"><select name="wedend"><?php echo $wedendcboxoptions; ?></select></td>
		<td class="lastcol"></td>
	</tr>
	<tr class="alt">
		<td class="firstcol" align="left"><b>Thursday:</b></td>
		<td align="center"><select name="thustart"><?php echo $thustartcboxoptions; ?></select></td>
		<td align="center"><select name="thuend"><?php echo $thuendcboxoptions; ?></select></td>
		<td class="lastcol"></td>
	</tr>
	<tr>
		<td class="firstcol" align="left"><b>Friday:</b></td>
		<td align="center"><select name="fristart"><?php echo $fristartcboxoptions; ?></select></td>
		<td align="center"><select name="friend"><?php echo $friendcboxoptions; ?></select></td>
		<td class="lastcol"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="center"><select name="satstartweekend"><?php echo $satstartcboxoptions; ?></select></td>
		<td align="center"><select name="satendweekend"><?php echo $satendcboxoptions; ?></select></td>
	...
	<tr class="alt">
		...
		<td align="center"><select name="sunstartweekend"><?php echo $sunstartcboxoptions; ?></select></td>
		<td align="center"><select name="sunendweekend"><?php echo $sunendcboxoptions; ?></select></td>
		<td class="lastcol"></td>
	</tr>
</table>
<br />
...
<br />
<input type="submit" name="button1" value="Save For THIS Summer Site and Continue &#62;&#62;" /> <input type="submit" name="button2" value="Save For ALL Summer Sites and Continue &#62;&#62;" />
</form>
