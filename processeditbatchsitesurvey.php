...
// check to see if site survey data exists and update - if not insert 
...
if ($countsite==0) {
	...
	require('inserteditbatchsitesurvey.php');
}else{
	// update site survey into database
	require('updateeditbatchsitesurvey.php');
}
...
header("Location: http://maps.nijel.org/azcase_dev/editbatchsitesurvey.php?lastsiteid=$siteid");
?>
