...
$kmlbody .= $kmlstyle;
$kmlbody .= "	<description><![CDATA[Number of Sites: <b>$sitescount</b><br />Number of Sites that Require Fingerprinting : <b>$fingerprintcount</b><br />Number of Sites that Require Drug Testing: <b>$drugtestcount</b><br />Number of Sites that Require Background Checks: <b>$backgroundcheckcount</b><br />Number of Sites that Require Personal References: <b>$personalrefscount</b><br />Number of Sites that Require Other Checks: <b>$othercheckcount</b><br />]]></description>";
