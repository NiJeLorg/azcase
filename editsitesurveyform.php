...
if ($charge=='t' && $costsame=='t') {
	...
	$costsame = '<input type="hidden" name="costsame" value="" />';
}
...
if ($otherassistance=='t') {
	...
	$otherassistancedescription = '<input type="hidden" name="otherassistancedescription" value="" />';
}
...
if ($transportation=='t') {
	...
	$transportcost = '<input type="hidden" name="transportcost" value="" />';
}
...
<table>
	<tr>
		<td>
		<form name="skipthissite" id="skipthissite" action="thankyoueditsite.php" method="POST">
...
<br />
<form name="editsitesurvey" id="editsitesurvey" action="processeditsitesurvey.php" method="POST">
