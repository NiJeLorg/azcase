...
$parentotherdescriptiontext = pg_result($record, $lt, 6);
...
$searchurl = "search.php?searchstreet=$searchstreet&searchcity=$searchcity&searchstate=$searchstate&searchzip=$searchzip&zoom=$zoom&language=$language"; 
...
if ($wp_pledge_id) {
	$WPUrl = "http://f28.b79.myftpupload.com/wp-json/posts?type=pledge&filter[page_id]=" . urlencode($wp_pledge_id);
} else {
	...
	$WPUrl = "http://f28.b79.myftpupload.com/wp-json/posts?type=pledge&filter[s]=" . urlencode($sitenamesearch);
}
