...
<form name="editsites" id="editsites" action="processeditsites.php" method="POST" onSubmit="return validateForm();">
<input type="hidden" name="siteid_old" value="<?php echo $siteid; ?>">
<input type="hidden" name="locationid_old" value="<?php echo $locationidselected; ?>">
<input type="hidden" name="summer" value="<?php echo $summer; ?>">
<table cellpadding="2">
	<tr>
		<td align="right" width="125"><b>Site Name: </b></td>
		<td align="left"><input type="text" name="sitename" value="<?php echo $name; ?>" /><span class="required">*</span></td>
	</tr>
	<tr>
		<td align="right" width="125"><b>Site Name (Espanol): </b></td>
		<td align="left"><input type="text" name="sitenamesp" value="<?php echo $namesp; ?>" /></td>
	</tr>
	<tr>
		<td align="right" width="125"><b>Location: </b></td>
		<td align="left"><select name="locationid" style="width: 250px;"><?php echo $locationcboxoptions; ?></select><span class="required">* </span><a href="neweditlocations.php?siteid=<?php echo $siteid; ?>">Add New Locations</a></td>
	</tr>
	<tr>
		<td align="right" width="125"><b>Site Phone: </b></td>
		<td align="left"><input type="text" name="phone" size = "10" value="<?php echo $phone; ?>" /><span class="required">* </span></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left"><input type="text" name="email" value="<?php echo $email; ?>" /><span class="required">* </span></td>
	</tr>
	<tr>
		<td align="right" width="125"><b>Site Website: </b></td>
		<td align="left"><input type="text" name="url" value="<?php echo $url; ?>" /></td>
	</tr>
</table>
<br />
