...
<p>If you would like to remove this location, please click the "Remove Location" button below. <b>Please note that this operation cannot be undone!</b></p>
...
<p>The following sites are associated with the above location. <b>By removing the above location, you will also remove their association with the sites below. You will not remove these sites from the system.</b></p> 
