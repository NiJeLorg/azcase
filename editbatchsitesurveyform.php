...
<table>
	<tr>
		<td>
		<form name="skipthissite" id="skipthissite" action="editbatchsitesurvey.php" method="POST">
			<input type="hidden" name="lastsiteid" value="<?php echo $siteid; ?>" />
			<input type="submit" name="action" value="Skip This Site &#62;&#62;" />
		</form>
		</td>
		<td>
		<form name="skipallsites" id="skipallsites" action="thankyoueditbatchsite.php" method="POST">
			<input type="hidden" name="lastsiteid" value="<?php echo $siteid; ?>" />
...
<br />
<form name="editsitesurvey" id="editsitesurvey" action="processeditbatchsitesurvey.php" method="POST" onSubmit="return validateForm();">
