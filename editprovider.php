...
<form name="editprovider" action="processeditprovider.php" method="POST" onSubmit="return validateForm();">
<table cellpadding="2">
	<tr>
...
<h1>Assign Other Users to Manage Data for <?php echo $orgname; ?></h1>
<p>If you would like to add other users to assist in managing data for <?php echo $orgname; ?>, please enter their email address below.</p>
<form name="search" action="assignusers.php" method="POST">
<table cellpadding="2">
	<tr>
...
$otheruserstable = "<h1>Other Users Assigned to Manage Data for $orgname</h1>
<p>If you would like to remove any users from the management of your organization's data, please select them below.</p>
<form name=\"editremove\" action=\"processremoveassignusers.php\" method=\"POST\">
