...
define("KEY", "ABQIAAAAtiEBPYWWUG-VvfdCk_EApxQuGSQ7M0zeJZor2xt9kNLFuArbwBQBv8KfxUL8s_UtxEIV9D8V07GUxg");
...
if (!$geocodeaddress) {
	...
	$latsearch = $coordinatesSplit[1];
	$lonsearch = $coordinatesSplit[0];
...
<table border="0">
	<tr>
		<td>
			<form name="search" action="neweditlocations.php" method="POST"><input type="text" name="geocodeaddress" style="color:#888;" value="Search by Address" onfocus="inputFocus(this)" onblur="inputBlur(this)"/><input type="submit" name="action" value="Search" /></form>
		</td>
	...
	<tr>
		...
		<td width="300" valign="bottom" align="right"><form name="addassociatedlocations" action="editsite.php" method="POST"><input type="hidden" name="siteid" value="<?php echo $siteid; ?>"><input type="submit" name="action" value="Save and Continue &#62;&#62;" /></form></td>
	</tr>
</table>
<br />
<?php
...
require('addneweditlocationsform.php'); 
